...
你应该会看到这样一个站点：
![初始化后的页面](../public/images/blog/init.png)
...
![新建仓库](../public/images/blog/newrepo.png)
...
![Git Bash](../public/images/blog/gitbash.png)
...
![查看密钥](../public/images/blog/key.png)

密钥复制备用， ~~待会下锅。~~ 

打开 [你的 Github 密钥配置界面](https://github.com/settings/keys)

![密钥配置](../public/images/blog/configUI.png)

点击 `New SSH key` ，将你的密钥输入进去并起一个 title 。

![起个title](../public/images/blog/titlekey.png)
...
![删除密钥](../public/images/blog/delkey.png)
:::
...
![VSCode 界面](../public/images/blog/VSC.png)

我们选择打开文件夹，找到并在 VSCode 打开你设置的 vitepress 项目目录。

![打开你的项目目录](../public/images/blog/opendir.png)
...
![你的仓库](../public/images/blog/yourrepo.png)
...
![启用 Actions ](../public/images/blog/enableactions.png)

接下来回到 VSCode 。

找到 `config.mts`，打开：

![你的 config.mts ](../public/images/blog/configmts.png)
...
![正在工作中的 Actions ](../public/images/blog/actionsrunning.png)

如果一切顺利，你应该看到的界面如下：

![ACtions 完成部署](../public/images/blog/finished.png)
...
![成功部署的博客](../public/images/blog/final.png)